...
<?php if($months==1)
echo "<p class='text'>Mai este $months luna pana la echinoctiul de toamna</p>";
if($months==0)
echo "<p class='text'>Luna aceasta va avea loc echinoctiul de toamna</p>";
 else 
echo "<p class='text'>Mai sunt $months luni pana la echinoctiul de toamna</p>"; ?>
