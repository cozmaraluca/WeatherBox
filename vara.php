...
<?php if($months==1)
echo "<p class='text'>Mai este $months luna pana la solstitiul de vara</p>";
if($months==0)
echo "<p class='text'>Luna aceasta va avea loc solstitiul de vara</p>";
 else 
echo "<p class='text'>Mai sunt $months luni pana la solstitiul de vara</p>"; ?>
